...
pub static PRODUCTS: &[Product] = &[
    ...
    Product {
        field: FieldDescriptor {
            ...
            source: DataSource::NoaaMrms,
            family: FieldFamily::Mrms,
            name: "Rainfall rarity, 30 min (ARI)",
    ...
    Product {
        field: FieldDescriptor {
            ...
            source: DataSource::NoaaMrms,
            family: FieldFamily::Mrms,
            name: "Rainfall rarity, 1 hour (ARI)",
    ...
    Product {
        field: FieldDescriptor {
            ...
            source: DataSource::NoaaMrms,
            family: FieldFamily::Mrms,
            name: "Rainfall rarity, 3 hours (ARI)",
    ...
    Product {
        field: FieldDescriptor {
            ...
            source: DataSource::NoaaMrms,
            family: FieldFamily::Mrms,
            name: "Rainfall rarity, 6 hours (ARI)",
    ...
    Product {
        field: FieldDescriptor {
            ...
            source: DataSource::NoaaMrms,
            family: FieldFamily::Mrms,
            name: "Rainfall rarity, 12 hours (ARI)",
    ...
    Product {
        field: FieldDescriptor {
            ...
            source: DataSource::NoaaMrms,
            family: FieldFamily::Mrms,
            name: "Rainfall rarity, 24 hours (ARI)",
